<?php /* Vista principal de la landing page de ALCALD+IA.
   Contiene hero, sobre, características, portal, nosotros y contacto.
   Variables: ninguna requerida (título y descripción tienen defaults).
   Extiende: layouts/home. */ ?>
...
<?= $this->section('content') ?>
  ...
  <section id="hero">
    ...
    <div class="hero-content">
      <img src="<?= base_url('assets/alcaldia-logo.webp') ?>" alt="ALCALD+IA" class="hero-logo">
    ...
    <div class="container">
      ...
      <div class="carousel-container">
        <div class="carousel" id="carousel">
          <div class="slide">
            <img src="<?= base_url('assets/carousel/') ?>01- Portal Vista Principal.jpg" alt="Vista principal del portal de pagos">
          ...
          <div class="slide">
            <img src="<?= base_url('assets/carousel/') ?>02 - Portal Vista Principal - contribuyente no encontrado.jpg" alt="Búsqueda de contribuyente">
            <div class="slide-caption">
          ...
          <div class="slide">
            <img src="<?= base_url('assets/carousel/') ?>03 - Portal Vista Principal - contribuyente.jpg" alt="Datos del contribuyente">
            <div class="slide-caption">
          ...
          <div class="slide">
            <img src="<?= base_url('assets/carousel/') ?>04 - Portal Vista Principal - contribuyente - Detalle de Boletas.jpg" alt="Detalle de boletas">
            <div class="slide-caption">
          ...
          <div class="slide">
            <img src="<?= base_url('assets/carousel/') ?>05 - Portal Vista Principal - contribuyente - Filtro por Concepto.jpg" alt="Filtros de búsqueda">
            <div class="slide-caption">
          ...
          <div class="slide">
            <img src="<?= base_url('assets/carousel/') ?>06 - Portal Vista Principal - Botonera.jpg" alt="Botonera de acciones">
            <div class="slide-caption">
          ...
          <div class="slide">
            <img src="<?= base_url('assets/carousel/') ?>07 - Portal - Previsualizacion de Ticket.jpg" alt="Previsualización de ticket">
            <div class="slide-caption">
          ...
          <div class="slide">
            <img src="<?= base_url('assets/carousel/') ?>08 - Portal Vista Principal - Opcion de Pago - MP.jpg" alt="Integración SIRO">
            <div class="slide-caption">
              <h4>Pago con SIRO</h4>
          ...
          <div class="slide">
            <img src="<?= base_url('assets/carousel/') ?>09 - Ticket PDF.jpg" alt="Ticket en PDF">
            <div class="slide-caption">
              <h4>Ticket en PDF</h4>
          ...
          <div class="slide">
            <img src="<?= base_url('assets/carousel/') ?>10 - pago exitoso.jpg" alt="Confirmación de pago exitoso">
            <div class="slide-caption">
              <h4>Pago Exitoso</h4>
          ...
          <div class="slide">
            <img src="<?= base_url('assets/carousel/') ?>11 - pago fallido.jpg" alt="Notificación de pago fallido">
            <div class="slide-caption">
          ...
          <div class="slide">
            <img src="<?= base_url('assets/carousel/') ?>12 - pago pendiente.jpg" alt="Estado de pago pendiente">
            <div class="slide-caption">
      ...
      <div class="portal-payment-info">
        <div class="payment-current">
          <img src="<?= base_url('assets/images/siro-logo.webp') ?>" alt="SIRO" class="payment-logo" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
    ...
    <div class="container">
      ...
      <div class="contacto-content">
        <div class="contacto-info">
          ...
          <a href="https://wa.me/+543515575700?text=Hola,%20quiero%20agendar%20una%20demo%20de%20ALCALD+IA" class="btn btn-whatsapp" target="_blank" rel="noopener noreferrer">
